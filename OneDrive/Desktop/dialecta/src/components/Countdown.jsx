...
//   return (
//     <React.Fragment>
//       <div className="flex flex-wrap mt-0 ml-10">
//         <div className="  grid grid-flow-col gap-10 text-center auto-cols-max">
//           <div className="flex flex-col">
//             <h1 className=" flex flex-col font-mono text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
//               {countdown.days}
...
//           </div>
//           <div>
//             <h1 className=" flex flex-col countdown font-mono text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
//               {countdown.hours}
//               <span className="text-sm sm:text-base md:text-lg lg:text-xl mt-1">
